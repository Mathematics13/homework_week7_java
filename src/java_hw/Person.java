...
/* Person
 *  This class has three variabes firstName, lastName and age.
 * Checks the given age of a person is Teen or not.
 * Also, provides output of fullName by concatenating firstName and lastName
 */
...
public class Person
{
  ...
  {
    if(age<0 || age>100)                         // checks the condition if the age is less than 0 or greater than 100 and sets the age to 0
    {
      this.age=0;
    }
    else
